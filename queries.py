...
CREATE_PARTITIONED_ELECTRONIC_DATA_TABLE = f"""
CREATE TABLE IF NOT EXISTS {config.TRAFFIC_SCHEMA}.electronic_count_data_partitioned (
...
CREATE_ELECTRONIC_HEADER_TABLE = f"""
CREATE TABLE IF NOT EXISTS {config.TRAFFIC_SCHEMA}.electronic_count_header (
	id int8 NOT NULL GENERATED BY DEFAULT AS IDENTITY,
...
CREATE INDEX electronic_count_header_header_id_idx ON {config.TRAFFIC_SCHEMA}.electronic_count_header USING btree (header_id);
CREATE INDEX electronic_count_header_id_idx ON {config.TRAFFIC_SCHEMA}.electronic_count_header USING btree (id);
CREATE INDEX electronic_count_header_site_id_idx ON {config.TRAFFIC_SCHEMA}.electronic_count_header USING btree (site_id);
CREATE UNIQUE INDEX electronic_count_header_un ON {config.TRAFFIC_SCHEMA}.electronic_count_header USING btree (site_id, start_datetime, end_datetime);
...
declare yearStart date := date_trunc('year', start_datetime);
    ...
    declare tableName text := '{config.TRAFFIC_SCHEMA}.electronic_count_data_' || to_char(start_datetime, 'YYYY');
begin
    ...
    if to_regclass(tableName) is null then
		...
		execute format('create table if not exists %I partition of {config.TRAFFIC_SCHEMA}.electronic_count_data for values from (%L) to (%L)', tableName, yearStart, yearEndExclusive);
...
CREATE_TYPE10_HEADER_TABLE_QRY = f"""
CREATE TABLE IF NOT EXISTS {config.TRAFFIC_SCHEMA}.electronic_count_header_type_10 (
	header_id uuid NOT NULL,
...
CREATE_TYPE10_DATA_TABLE_QRY = f"""
CREATE TABLE IF NOT EXISTS {config.TRAFFIC_SCHEMA}.electronic_count_data_type10 (
...
CREATE UNIQUE INDEX electronic_count_data_type10_id_idx ON {config.TRAFFIC_SCHEMA}.electronic_count_data_type10 USING btree (data_id);"""

CREATE_AXLE_SPACING_TABLE_SX = f"""
CREATE TABLE IF NOT EXISTS {config.TRAFFIC_SCHEMA}.electronic_count_data_type_10_axle_spacing (
...
create index axle_spacing_data_id_idx ON {config.TRAFFIC_SCHEMA}.electronic_count_data_type_10_axle_spacing using btree (data_id);
"""

CREATE_AXLE_GROUP_CONFIG_TABLE_CX = f"""
CREATE TABLE IF NOT EXISTS {config.TRAFFIC_SCHEMA}.traffic_e_type10_axle_group_configuration (
...
CREATE INDEX traffic_e_type10_axle_group_configuration_type10_id_idx ON {config.TRAFFIC_SCHEMA}.traffic_e_type10_axle_group_configuration USING btree (type10_id);"""

CREATE_AXLE_GROUP_MASS_TABLE_GX = f"""
CREATE TABLE IF NOT EXISTS {config.TRAFFIC_SCHEMA}.traffic_e_type10_axle_group_mass (
	id int8 NOT NULL GENERATED ALWAYS AS IDENTITY,
	type10_id uuid NOT NULL,
	sub_data_type_code varchar NULL,
...
CREATE INDEX traffic_e_type10_axle_group_mass_type10_id_idx ON {config.TRAFFIC_SCHEMA}.traffic_e_type10_axle_group_mass USING btree (type10_id);"""

CREATE_AXLE_MASS_TABLE_AX = f"""
CREATE TABLE IF NOT EXISTS {config.TRAFFIC_SCHEMA}.traffic_e_type10_axle_mass (
	id int8 NOT NULL GENERATED ALWAYS AS IDENTITY,
	type10_id uuid NOT NULL,
	sub_data_type_code varchar NULL,
	offset_sensor_detection_code varchar NULL,
...
CREATE INDEX traffic_e_type10_axle_mass_type10_id_idx ON {config.TRAFFIC_SCHEMA}.traffic_e_type10_axle_mass USING btree (type10_id);"""

CREATE_AXLE_SPACING_TABLE_SX = f"""
CREATE TABLE IF NOT EXISTS {config.TRAFFIC_SCHEMA}.traffic_e_type10_axle_spacing (
	id int8 NOT NULL GENERATED ALWAYS AS IDENTITY,
	type10_id uuid NOT NULL,
	sub_data_type_code varchar NULL,
...
CREATE INDEX traffic_e_type10_axle_spacing_type10_id_idx ON {config.TRAFFIC_SCHEMA}.traffic_e_type10_axle_spacing USING btree (type10_id);"""

CREATE_IMAGES_TABLE_VX = f"""
CREATE TABLE IF NOT EXISTS {config.TRAFFIC_SCHEMA}.traffic_e_type10_identification_data_images (
	id int8 NOT NULL GENERATED ALWAYS AS IDENTITY,
	type10_id uuid NOT NULL,
	sub_data_type_code varchar NULL,
...
CREATE INDEX traffic_e_type10_identification_data_images_type10_id_idx ON {config.TRAFFIC_SCHEMA}.traffic_e_type10_identification_data_images USING btree (type10_id);"""

CREATE_TYRE_TABLE_TX = f"""
REATE TABLE IF NOT EXISTS {config.TRAFFIC_SCHEMA}.traffic_e_type10_tyre (
	id int8 NOT NULL GENERATED ALWAYS AS IDENTITY,
	type10_id uuid NOT NULL,
	sub_data_type_code varchar NULL,
...
CREATE INDEX traffic_e_type10_tyre_type10_id_idx ON {config.TRAFFIC_SCHEMA}.traffic_e_type10_tyre USING btree (type10_id);"""

CREATE_WHEEL_MASS_TABLE_WX = f"""
CREATE TABLE IF NOT EXISTS {config.TRAFFIC_SCHEMA}.traffic_e_type10_wheel_mass (
	id int8 NOT NULL GENERATED ALWAYS AS IDENTITY,
	type10_id uuid NOT NULL,
	sub_data_type_code varchar NULL,
	offset_sensor_detection_code varchar NULL,
...
CREATE INDEX traffic_e_type10_wheel_mass_type10_id_idx ON {config.TRAFFIC_SCHEMA}.traffic_e_type10_wheel_mass USING btree (type10_id);"""

ADD_COLUMNS_TO_HEADER = f"""
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column mean_equivalent_axle_mass numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column mean_equivalent_axle_mass_positive_direction numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column mean_equivalent_axle_mass_negative_direction numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column mean_axle_spacing numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column mean_axle_spacing_positive_direction numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column mean_axle_spacing_negative_direction numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column e80_per_axle numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column e80_per_axle_positive_direction numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column e80_per_axle_negative_direction numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column olhv numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column olhv_positive_direction numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column olhv_negative_direction numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column olhv_percent numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column olhv_percent_positive_direction numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column olhv_percent_negative_direction numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column tonnage_generated numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column tonnage_generated_positive_direction numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column tonnage_generated_negative_direction numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column olton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column olton_positive_direction numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column olton_negative_direction numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column olton_percent numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column olton_percent_positive_direction numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column olton_percent_negative_direction numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column ole80 numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column ole80_positive_direction numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column ole80_negative_direction numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column ole80_percent numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column ole80_percent_positive_direction numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column ole80_percent_negative_direction numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column xe80 numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column xe80_positive_direction numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column xe80_negative_direction numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column xe80_percent numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column xe80_percent_positive_direction numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column xe80_percent_negative_direction numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column e80_per_day numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column e80_per_day_positive_direction numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column e80_per_day_negative_direction numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column e80_per_heavy_vehicle numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column e80_per_heavy_vehicle_positive_direction numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column e80_per_heavy_vehicle_negative_direction numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_steering_single_axle_cnt numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_steering_single_axle_olhv_perc numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_steering_single_axle_tonperhv numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_steering_double_axle_cnt numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_steering_double_axle_olhv_perc numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_steering_double_axle_tonperhv numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_non_steering_single_axle_cnt numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_non_steering_single_axle_olhv_perc numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_non_steering_single_axle_tonperhv numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_non_steering_double_axle_cnt numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_non_steering_double_axle_olhv_perc numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_non_steering_double_axle_tonperhv numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_triple_axle_cnt numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_triple_axle_olhv_perc numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_triple_axle_tonperhv numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column bridge_formula_cnt numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column bridge_formula_olhv_perc numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column bridge_formula_tonperhv numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column gross_formula_cnt numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column gross_formula_olhv_perc numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column gross_formula_tonperhv numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column total_avg_cnt numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column total_avg_olhv_perc numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column total_avg_tonperhv numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_steering_single_axle_cnt_positive_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_steering_single_axle_olhv_perc_positive_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_steering_single_axle_tonperhv_positive_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_steering_double_axle_cnt_positive_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_steering_double_axle_olhv_perc_positive_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_steering_double_axle_tonperhv_positive_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_non_steering_single_axle_cnt_positive_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_non_steering_single_axle_olhv_perc_positive_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_non_steering_single_axle_tonperhv_positive_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_non_steering_double_axle_cnt_positive_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_non_steering_double_axle_olhv_perc_positive_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_non_steering_double_axle_tonperhv_positive_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_triple_axle_cnt_positive_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_triple_axle_olhv_perc_positive_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_triple_axle_tonperhv_positive_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column bridge_formula_cnt_positive_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column bridge_formula_olhv_perc_positive_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column bridge_formula_tonperhv_positive_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column gross_formula_cnt_positive_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column gross_formula_olhv_perc_positive_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column gross_formula_tonperhv_positive_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column total_avg_cnt_positive_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column total_avg_olhv_perc_positive_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column total_avg_tonperhv_positive_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_steering_single_axle_cnt_negative_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_steering_single_axle_olhv_perc_negative_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_steering_single_axle_tonperhv_negative_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_steering_double_axle_cnt_negative_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_steering_double_axle_olhv_perc_negative_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_steering_double_axle_tonperhv_negative_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_non_steering_single_axle_cnt_negative_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_non_steering_single_axle_olhv_perc_negative_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_non_steering_single_axle_tonperhv_negative_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_non_steering_double_axle_cnt_negative_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_non_steering_double_axle_olhv_perc_negative_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_non_steering_double_axle_tonperhv_negative_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_triple_axle_cnt_negative_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_triple_axle_olhv_perc_negative_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column worst_triple_axle_tonperhv_negative_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column bridge_formula_cnt_negative_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column bridge_formula_olhv_perc_negative_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column bridge_formula_tonperhv_negative_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column gross_formula_cnt_negative_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column gross_formula_olhv_perc_negative_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column gross_formula_tonperhv_negative_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column total_avg_cnt_negative_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column total_avg_olhv_perc_negative_direciton numeric;
alter table {config.TRAFFIC_SCHEMA}.electronic_count_header add column total_avg_tonperhv_negative_direciton numeric;
"""

CREATE_HSWIM_HEADER_TABLE = f"""
CREATE TABLE IF NOT EXISTS {config.TRAFFIC_SCHEMA}.electronic_count_header_hswim (
...
GET_GROSS_VEHICLE_MASS_LIMITS = f"""
SELECT id, number_of_axles, kg, ton
FROM traf_lu.gross_vehicle_mass_limits;
"""

GET_AXLE_LOAD_LIMITS = f"""
SELECT id, "type", kg, ton
FROM traf_lu.axle_load_limits;
"""

GET_HSWIM_HEADER_IDS = f"""
	SELECT DISTINCT header_id from {config.TRAFFIC_SCHEMA}.electronic_count_data_type_10 t10 
    where not exists (select header_id from {config.TRAFFIC_SCHEMA}.electronic_count_header_hswim h where h.header_id = t10.header_id)
    and 
    (
        exists (select header_id from {config.TRAFFIC_SCHEMA}.traffic_e_type10_wheel_mass m where m.type10_id = t10.data_id)
        or
        exists (select header_id from {config.TRAFFIC_SCHEMA}.traffic_e_type10_axle_group_mass m where m.type10_id = t10.data_id)
        or
        exists (select header_id from {config.TRAFFIC_SCHEMA}.traffic_e_type10_axle_mass m where m.type10_id = t10.data_id)
    )
    ;"""

SELECT_PARTITION_TABLE_LIMIT1 = f"""
	SELECT * from {config.TRAFFIC_SCHEMA}.electronic_count_data_partitioned limit 1
"""

SELECT_ELECTRONIC_COUNT_DATA_TYPE_21_LIMIT1 = f"""
	SELECT * from {config.TRAFFIC_SCHEMA}.electronic_count_data_type_21 limit 1
"""

SELECT_ELECTRONIC_COUNT_DATA_TYPE_30_LIMIT1 = f"""
	SELECT * from {config.TRAFFIC_SCHEMA}.electronic_count_data_type_30 limit 1
"""

SELECT_ELECTRONIC_COUNT_DATA_TYPE_60_LIMIT1 = f"""
	SELECT * from {config.TRAFFIC_SCHEMA}.electronic_count_data_type_60 limit 1
"""

SELECT_ELECTRONIC_COUNT_DATA_TYPE_70_LIMIT1 = f"""
	SELECT * from {config.TRAFFIC_SCHEMA}.electronic_count_data_type_70 limit 1
"""

SELECT_ELECTRONIC_COUNT_DATA_TYPE_10_LIMIT1 = f"""
	SELECT * from {config.TRAFFIC_SCHEMA}.electronic_count_data_type_10 limit 1
"""

SELECT_HEADER_LIMIT1 = f"""
	SELECT * from {config.TRAFFIC_SCHEMA}.electronic_count_header limit 1
"""

SELECT_CLASSIFICAITON_SCHEME_8 = f"""
	SELECT * FROM traf_lu.vehicle_classes_scheme08;
"""

SELECT_CLASSIFICAITON_SCHEME_1 = f"""
	SELECT * FROM traf_lu.vehicle_classes_scheme01 ;
"""

SELECT_CLASSIFICAITON_SCHEME_5 = f"""
